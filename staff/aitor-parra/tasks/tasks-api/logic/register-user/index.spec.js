...
describe('logic - register user', () => {
    ...
    it('should succeed on correct credentials', () =>
        registerUser(name, surname, email, username, password)
            .then(response => {
                ...
                return fs.readFile(path.join(__dirname, '../../data/users.json')) //llencem un return i aixi el seguent then() s'esperara a la resposta.
            })
            .then(json => {
    ...
    describe('when user already exists', () => {
        ...
        beforeEach(done => {
            ...
            users.push({ name, surname, email, username, password }) //inferimos en memoria
